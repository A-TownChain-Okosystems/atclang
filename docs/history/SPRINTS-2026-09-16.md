...
Gilt fuer die Python-Aera VOR der Rust-Transition (17.09., Welle 2, e915589): Python-Referenz geloescht, atclang Rust-only.
Offene Findings (F-008/F-006 Determinismus/Clock) laufen heute unter der SCR-0128-Roadmap (injizierbare Clock/Nonce, Welle 3).
F-015 Dependency-Review = org-weite F-ORG-002 Owner-Aktion.
-->

...
def opcode_name(self) -> str:
    """
    Stable human-readable opcode name.
    """
...
Entries must be stored in monotonically increasing instruction order.
"""
...
def freeze_constants(self) -> None:
    ...
    Nach diesem Punkt können keine neuen Konstanten mehr in den
...
Opcode and VM-specific instruction reconstruction remains outside
this module.
"""

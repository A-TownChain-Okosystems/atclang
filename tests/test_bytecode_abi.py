...
assert encode_f64(value) == struct.pack(
    ">d",
    value,
)
...
# Swap the first two section IDs.
first_id = encoded[20:24]
second_offset = 20 + 8 + struct.unpack(
    ">I",
    encoded[24:28],
)[0]
second_id = encoded[
